# AUTOGENERATED! DO NOT EDIT! File to edit: 02_preprocessing_vocabs.ipynb (unless otherwise specified).
...
class EhrVocab():
    ...
    def numericalize(self, codes, verbose=LOG_NUMERICALIZE_EXCEP):
